...
cmp_ok "echo foo" -eq 0 "checking only return value #1"
cmp_ok "echo foo" != "foo" "checking only return value #2"
...
cmp_ok 'echo not ok - dummy' -eq 0 "stdout will be commented out"
